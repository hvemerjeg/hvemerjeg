...
#the letter that corresponds to a decimal value, and the ord function returns the decimal value that corresponds to a letter. You can find all of this 
#correlations between values and letters searching for the ASCII table. 
    cipher_text = ''
